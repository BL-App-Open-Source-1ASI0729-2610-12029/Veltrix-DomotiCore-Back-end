...
public class AutomationBuilderTriggersController extends AbstractUserScopedJsonCollectionController {

    public AutomationBuilderTriggersController(
            UserCollectionAccessService userCollectionAccessService,
            CurrentUserProvider currentUserProvider) {
        super(userCollectionAccessService, currentUserProvider, "automation-builder-triggers");
    }
}
