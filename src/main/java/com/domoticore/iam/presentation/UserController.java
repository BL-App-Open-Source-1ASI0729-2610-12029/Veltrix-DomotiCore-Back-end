...
import com.domoticore.shared.infrastructure.config.openapi.ApiUserSelfResponses;
...
public class UserController {
    ...
    public UserResponse getUser(@PathVariable Long id) {
        ...
        return userQueryService.handle(new GetUserByIdQuery(id))
                ...
                .orElseThrow(() -> new com.domoticore.shared.domain.model.ResourceNotFoundException(
